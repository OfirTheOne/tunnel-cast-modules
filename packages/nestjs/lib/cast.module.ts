...
export class CastModule {
  static forFeature(
    factoryParams: Partial<CastModuleFactoryParameters> = {}
  ): DynamicModule {
...
function buildFeatureProviders(
  factoryParams: Partial<CastModuleFactoryParameters>
): Array<Provider<any>> {
  return [
    {
    ...
    },
    {
      ...
      useValue: {
        ...
        transformError:
          factoryParams.transformError || defaultOptions.transformError
