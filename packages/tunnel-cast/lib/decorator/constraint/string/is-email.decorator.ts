...
const buildDomainSpecificEmailRegex = (domains: Array<string>) =>
    new RegExp(
        "^[a-z0-9!#$%&'*+=?^_‘{|}~-]+(?:.[a-z0-9!#$%&'*+=?^_‘{|}~-]+)*@(" +
 ...
 * @param param0
 */
export const isEmail: FieldConstraintFn<{ domains?: Array<string> }> = ({ fieldValue, args }) => {
...
export function IsEmail(
    domainsOrOps?: Array<string> | FieldConstraintProcedureOptions,
