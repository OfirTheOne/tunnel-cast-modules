...
function castEngine(castProceduresListEntries: Array<[string, FieldProcedure[]]>, target: any, projectedContext: any, options?: any) {
...
function executeCastProcedures(field: string, procedures: Record<FieldProcedureType, FieldProcedure[]>, target: any, projectedContext: any, options?: any) {
